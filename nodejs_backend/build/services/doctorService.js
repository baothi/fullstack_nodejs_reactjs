...
var checkRequiredFields = function checkRequiredFields(inputData) {
  var arrFields = ["doctorId", "contentHTML", "contentMarkdown", "action", "selectedPrice", "selectedPayment", "selectedProvince", "addressClinic", "specialtyId", "clinicId"];
  var isValid = true;
  var element = '';
...
var createInforDoctor = function createInforDoctor(inputData) {
  return new Promise( /*#__PURE__*/function () {
...
var getSheduleByDate = function getSheduleByDate(doctorId, date) {
  return new Promise( /*#__PURE__*/function () {
