      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return transporter.sendMail({
            from: '"Lịch Khám Bệnh 👻" <hoaha2468@gmail.com>',
            // sender address
...
var getBodyHtmlEmail = function getBodyHtmlEmail(dataSend) {
  ...
  if (dataSend.language === 'vi') {
    result = "\n    <h3> xin ch\xE0o ".concat(dataSend.patientName, "!<h3>\n    <p> b\u1EA1n nh\u1EADn \u0111\u01B0\u1EE3c email n\xE0y v\xEC \u0111\xE3 d\u1EB7t l\u1ECBch kh\xE1m b\u1EC7nh online t\u1EEB doctorbook<p>\n    <p>Th\xF4ng tin \u0111\u1EB7t l\u1ECBch kh\xE1m b\u1EC7nh: <p>\n    <div><b> th\u1EDDi gian: ").concat(dataSend.time, "</b><div>\n    <div><b>B\xE1c s\u0129: ").concat(dataSend.doctorName, "</b></div>\n    <p> N\u1EBFu c\xE1c th\xF4ng tin tr\xEAn l\xE0 \u0111\xFAng s\u1EF1 th\u1EADt vui long click v\xE0o \u0111\u01B0\u1EDDng link tr\xEAn \u0111\u1EC3 x\xE1c nh\u1EADn ho\xE0n t\u1EA5t \u0111\u1EB7t l\u1ECBch kh\xE1m b\u1EC7nh </p>\n    <div>\n    <a href=").concat(dataSend.redirectLink, " target=\"_blank\">Click here\n    </div>\n    <div>Xin ch\xE2n th\xE0nh c\xE1m \u01A1n!</div>\n    ");
  }
...
var getBodyHTMLEmailRemedy = function getBodyHTMLEmailRemedy(dataSend) {
  var result = '';
  if (dataSend.language === 'vi') {
    result = "\n    <h3> xin ch\xE0o ".concat(dataSend.patientName, "!<h3>\n    <p> b\u1EA1n nh\u1EADn \u0111\u01B0\u1EE3c email n\xE0y v\xEC \u0111\xE3 d\u1EB7t l\u1ECBch kh\xE1m b\u1EC7nh online t\u1EEB doctorbook<p>\n    <p>Th\xF4ng tin \u0111\u01A1n thu\u1ED1c/ h\xF3a \u0111\u01A1n \u0111\u01B0\u1EE3c g\u1EDFi trong file \u0111\xEDnh k\xE8m: <p>\n    <div>Xin ch\xE2n th\xE0nh c\xE1m \u01A1n!</div>\n    ");
  }
  if (dataSend.language === 'en') {
    result = "\n    <h3> Dear ".concat(dataSend.patientName, "!<h3>\n    <p> You recevide this email because you booked an online medical appointment doctorbook<p>\n    <p>Information to schedule an appointment: <p>\n    <div>Sincerely thank!</div>\n    ");
  }
              ...
              return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                while (1) switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    _context2.next = 5;
                    return transporter.sendMail({
                      from: '"Kết quả khám bệnh 👻" <hoaha2468@gmail.com>',
                      // sender address
                      to: dataSend.reciverEmail,
                      // list of receivers
                      subject: "Thông Tin đặt lịch khám bệnh ✔",
